...
WebUI.setText(findTestObject('Object Repository/Page_Advantage Shopping/input_Sign out_autoComplete'), 'hp')

WebUI.click(findTestObject('Object Repository/Page_Advantage Shopping/img'))
